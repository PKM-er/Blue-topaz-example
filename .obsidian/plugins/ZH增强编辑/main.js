...
class MyPlugin extends obsidian.Plugin {
    ...
    智能符号 () {
        ...
        if(选至行尾.match(/^(\]\]|\=\=|\*\*|\~\~)/)){
            ...
            let coreAry = ["HTML","XML","VBScript|vbs","MATLAB","Java","C","C#","CSS","Objective-C","PHP","Visual Basic|vb","Basic","Python|pt","Perl","JavaScript|js","Delphi","Object Pascal","Ruby","Lisp","Pascal","Transact-SQL","PL","SQL","Ada","Logo","R","Lua"];
    ...
    标题语法(_str) {
       ...
       this.获取编辑器信息 ();
        ...
        if(_str==""){   //若为标题，转为普通文本
            ...
            新文本 = 当前行文本.replace(/^(\s*#+\s)?/,_str+" ");
            新定位 = 选至行首.replace(/^(\s*#+\s)?/,_str+" ");
        }
    ...
    转换背景颜色(_color) {
        let _html0 = /\<span style=[\"'][^\<\>]*color:[0-9a-zA-Z#]+[\"'][^\<\>]*\>[^\<\>]+\<\/span\>/g;
        let _html1 = /^\<span style=[\"'][^\<\>]*color:[0-9a-zA-Z#]+[\"'][^\<\>]*\>([^\<\>]+)\<\/span\>$/;
        let _html2 = '\<span style=\"background\-color:'+_color+'\"\>$1\<\/span\>';
