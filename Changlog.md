...
- ✔️新增内容
	...
	- 新增[filetree](obsidian://show-plugin?id=file-tree-alternative)插件 支持文件夹聚焦
	- 新增[commander](obsidian://show-plugin?id=cmdr) 插件方便标题栏设置快捷按钮
...
### 更新 📅2022-07-06
- ✔️新增内容
	- 增加dbfolder插件 并给出相关示例[[🎶影音数据库]]  [[📰数据化视图]]
