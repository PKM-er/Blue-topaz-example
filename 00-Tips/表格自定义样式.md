...
## 例子
### 默认表格样式
![[TableExample/01 - Default Table]]
### 深色紫红表格样式
![[TableExample/02 - PurpleRed]]
### 扁平化蓝色表格样式
![[TableExample/03 - FlatBlue]]
### 学术三线表样式
![[TableExample/04 - Latex like]]
### 圆角白红相间表格样式
![[TableExample/05 - White red rounded]]
### 白红相间表格样式
![[TableExample/05 - White red]]
### 黄底黑字居中样式
![[TableExample/06 - Yellow cab]]
### 默认表格居中样式
![[07 - Center Table]]